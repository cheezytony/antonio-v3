      ...
      >
        ...
        <VStack align="stretch" gap={3}>
          <Text fontSize="md" lineHeight={1.5} opacity={0.64}>
            ...
            vanquishing bugs, and creating tools people love to use but love to
            break even more. A master of turning abstract ideas into digital
            reality. I thrive in the chaos of shifting requirements and
            ever-tight deadlines. Whether it's building from scratch or
          ...
          <Text fontSize="md" lineHeight={1.5} opacity={0.64}>
            ...
            that push the boundaries. A digital explorer fueled by energy drinks
            and endless ambition, I conquer epic battles, optimize builds, and
            always find a way to squeeze in just one more game.
          </Text>
        </VStack>
      </MotionVStack>
